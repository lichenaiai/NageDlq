...
void CNageDlqServerDlg::OnSysCommand(UINT nID, LPARAM lParam)
{
...
void CNageDlqServerDlg::OnPaint()
{
	if (IsIconic())
	{
...
//显示。
HCURSOR CNageDlqServerDlg::OnQueryDragIcon()
{
